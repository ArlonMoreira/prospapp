...
from .views import RegisterPointJustifyView, ReportPointView, LocalDisableView, LocalViews, GetLocalViews, RegisterPointView, RegisterPointActualView, RemovePointTodayView, LocalUpdateView
...
urlpatterns = [
    ...
    re_path('justify/', RegisterPointJustifyView.as_view()),
