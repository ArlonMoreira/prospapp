"""
Django settings for prospapp project.
...
SECRET_KEY = os.environ['SECRET_KEY_PROSPAPP']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['prospapp.onrender.com', 'localhost', 'prosperefisio.com.br']
...
WSGI_APPLICATION = 'prospapp.wsgi.application'
